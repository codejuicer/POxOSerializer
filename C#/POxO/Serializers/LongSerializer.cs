...
public class LongSerializer : GenericClassSerializer
{

    public LongSerializer(Type classToSerialize)
    ...
    public override void write(POxOPrimitiveEncoder encoder, ObjectSerializer serializer, Object value)
    {
        ...
        {
            throw new POxOSerializerException("Error during Long serializing.", e);
        }
