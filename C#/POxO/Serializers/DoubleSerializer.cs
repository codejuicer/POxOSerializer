...
public class DoubleSerializer : GenericClassSerializer
{

    public DoubleSerializer(Type classToSerialize)
    ...
    public override void write(POxOPrimitiveEncoder encoder, ObjectSerializer serializer, Object value)
    {
        ...
        {
            throw new POxOSerializerException("Error during Double serializing.", e);
        }
    ...
    public override Object read(POxOPrimitiveDecoder decoder, ObjectSerializer serializer)
    {
        ...
        {
            throw new POxOSerializerException("Error during Double deserializing.", e);
        }
    }
}
