...
public class ShortSerializer : GenericClassSerializer
{

    public ShortSerializer(Type classToSerialize)
    ...
    public override void write(POxOPrimitiveEncoder encoder, Object value)
    {
        ...
        {
            throw new POxOSerializerException("Error during Short serializing.", e);
        }
    ...
    public override Object read(POxOPrimitiveDecoder decoder)
    {
        ...
        {
            throw new POxOSerializerException("Error during Short deserializing.", e);
        }
    }
}
