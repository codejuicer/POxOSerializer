...
public class IntegerSerializer : GenericClassSerializer
{

    public IntegerSerializer(Type classToSerialize)
    ...
    public override void write(POxOPrimitiveEncoder encoder, ObjectSerializer serializer, Object value)
    {
        ...
        {
            throw new POxOSerializerException("Error during Integer serializing.", e);
        }
    ...
    public override Object read(POxOPrimitiveDecoder decoder, ObjectSerializer serializer)
    {
        ...
        {
            throw new POxOSerializerException("Error during Integer deserializing.", e);
        }
    }
}
